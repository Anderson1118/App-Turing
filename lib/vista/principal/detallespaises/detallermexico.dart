...
class mexicode extends StatelessWidget {
  final String mexicoImagePath;
  final String mexicoName;

  mexicode({
    required this.mexicoImagePath,
    required this.mexicoName,
  });
        ...
        child: Column(
          ...
          children: [
            ClipRRect(
              ...
              child: Image.asset(mexicoImagePath),
            ),
            Padding(
              padding:
