...
class defavoritos extends StatefulWidget {
  const defavoritos({super.key});

  @override
  State<defavoritos> createState() => _defavoritosState();
}

class _defavoritosState extends State<defavoritos> {
  int _quantity = 0;
